...
const concat=function(s1,s2){
  return (s1.slice(0,2)+s2.slice(s2.length -3)).toUpperCase
}
concat("ciao","bella");
/* ESERCIZIO 2
...
*/
function filmRecenti(arr){
  let arr1=arr.filter(film=>{
